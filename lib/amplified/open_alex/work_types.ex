defmodule Amplified.OpenAlex.WorkTypes do
  @moduledoc """
  Provides API endpoint related to work types
  """
  ...
  ## Options
    ...
    * `filter`: Filter work types. Examples: `id:article`, `works_count:>1000000`
  ...
  """
  @spec list_work_types(opts :: keyword) ::
          {:ok, Amplified.OpenAlex.WorkTypesListResponse.t()}
          | {:error, Amplified.OpenAlex.Error.t()}
  def list_work_types(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Amplified.OpenAlex.WorkTypes, :list_work_types},
      url: "/work-types",
      method: :get,
      query: query,
      response: [
        {200, {Amplified.OpenAlex.WorkTypesListResponse, :t}},
