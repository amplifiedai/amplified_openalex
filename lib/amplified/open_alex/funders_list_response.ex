defmodule Amplified.OpenAlex.FundersListResponse do
  @moduledoc """
  Provides struct and type for a FundersListResponse
  """

  @type t :: %__MODULE__{
          group_by: [Amplified.OpenAlex.GroupByResult.t()] | nil,
          meta: Amplified.OpenAlex.Meta.t() | nil,
          results: [Amplified.OpenAlex.Funder.t()] | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      results: [{Amplified.OpenAlex.Funder, :t}]
    ]
  end
end
