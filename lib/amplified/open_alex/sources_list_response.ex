defmodule Amplified.OpenAlex.SourcesListResponse do
  @moduledoc """
  Provides struct and type for a SourcesListResponse
  """

  @type t :: %__MODULE__{
          group_by: [Amplified.OpenAlex.GroupByResult.t()] | nil,
          meta: Amplified.OpenAlex.Meta.t() | nil,
          results: [Amplified.OpenAlex.Source.t()] | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      results: [{Amplified.OpenAlex.Source, :t}]
    ]
  end
end
