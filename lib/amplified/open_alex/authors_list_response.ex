defmodule Amplified.OpenAlex.AuthorsListResponse do
  @moduledoc """
  Provides struct and type for a AuthorsListResponse
  """

  @type t :: %__MODULE__{
          group_by: [Amplified.OpenAlex.GroupByResult.t()] | nil,
          meta: Amplified.OpenAlex.Meta.t() | nil,
          results: [Amplified.OpenAlex.Author.t()] | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      results: [{Amplified.OpenAlex.Author, :t}]
    ]
  end
end
